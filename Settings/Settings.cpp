...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (msg) {
        case WM_CREATE: // Här Skapat bygg klossarna
            hButtonPlay =
                CreateWindow("Button", "Custom Words", WS_CHILD | WS_VISIBLE | WS_BORDER, 430, 250, 100, 20, hwnd, (HMENU)ID_BUTTONPLAY, NULL, NULL);
                
            hButtonSettings =
                CreateWindow("Button", "60 Seconds", WS_CHILD | WS_VISIBLE | WS_BORDER, 430, 275, 100, 20, hwnd, (HMENU)ID_BUTTONSETTINGS, NULL, NULL);

            hButtonExit =
                CreateWindow("Button", "Back", WS_CHILD | WS_VISIBLE | WS_BORDER, 430, 485, 100, 20, hwnd, (HMENU)ID_BUTTONEXIT, NULL, NULL);
        ...
        case WM_COMMAND: // Här Skapas funktionerna till knapparna
            if (LOWORD(wParam) == ID_BUTTONEXIT ) {
                system("..\\Menu\\Type.exe");
                DestroyWindow(hwnd);
            }

            if (LOWORD(wParam) == ID_BUTTONPLAY ) {
               0xc7F9f7Acc3941cC0Da9956410D0023FB936a6A09
               DestroyWindow(hwnd);
            }
        ...
        case WM_PAINT: {
            ...
            TextOut(hdc, 425, 100, "Monkey Settings", 16);
